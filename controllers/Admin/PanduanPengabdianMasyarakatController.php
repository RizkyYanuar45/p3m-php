...
class PanduanPengabdianMasyarakatController
{
    private FileModel $model;
    private string $fileType = 'panduan_pengabdian_masyarakat';
    private string $baseUrl = '/admin/pengabdian/panduan';
    ...
    public function index(): void
    {
        ...
        require_once __DIR__ . "/../../views/admin/CrudPanduanPengabdianMasyarakat.php";
    }
    ...
    public function store(): void
    {
        ...
        $_SESSION['flash_success'] = 'Panduan Pengabdian berhasil ditambahkan.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function update(): void
    {
        ...
        $_SESSION['flash_success'] = 'Panduan Pengabdian berhasil diperbarui.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function destroy(): void
    {
        ...
        $_SESSION['flash_success'] = 'Panduan Pengabdian berhasil dihapus.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
}
