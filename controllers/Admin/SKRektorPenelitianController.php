...
class SKRektorPenelitianController
{
    private FileModel $model;
    private string $fileType = 'sk_rektor_penelitian';
    private string $baseUrl = '/admin/penelitian/sk-rektor';
    ...
    public function index(): void
    {
        ...
        require_once __DIR__ . "/../../views/admin/CrudSKRektorPenelitian.php";
    }
    ...
    public function store(): void
    {
        ...
        $_SESSION['flash_success'] = 'SK Rektor berhasil ditambahkan.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function update(): void
    {
        ...
        $_SESSION['flash_success'] = 'SK Rektor berhasil diperbarui.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function destroy(): void
    {
        ...
        $_SESSION['flash_success'] = 'SK Rektor berhasil dihapus.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
}
