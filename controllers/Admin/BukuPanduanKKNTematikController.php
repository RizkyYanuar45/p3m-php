...
class BukuPanduanKKNTematikController
{
    private FileModel $model;
    private string $fileType = 'panduan_kkn_tematik';
    private string $baseUrl = '/admin/kkn/panduan-tematik';
    ...
    public function index(): void
    {
        ...
        require_once __DIR__ . "/../../views/admin/CrudBukuPanduanKKNTematik.php";
    }
    ...
    public function store(): void
    {
        ...
        $_SESSION['flash_success'] = 'Buku Panduan berhasil ditambahkan.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function update(): void
    {
        ...
        $_SESSION['flash_success'] = 'Buku Panduan berhasil diperbarui.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function destroy(): void
    {
        ...
        $_SESSION['flash_success'] = 'Buku Panduan berhasil dihapus.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
}
