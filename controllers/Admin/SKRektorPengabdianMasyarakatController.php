...
class SKRektorPengabdianMasyarakatController
{
    private FileModel $model;
    private string $fileType = 'sk_rektor_pengabdian_masyarakat';
    private string $baseUrl = '/admin/pengabdian/sk-rektor';
    ...
    public function index(): void
    {
        ...
        require_once __DIR__ . "/../../views/admin/CrudSKRektorPengabdianMasyarakat.php";
    }
    ...
    public function store(): void
    {
        ...
        $_SESSION['flash_success'] = 'SK Pengabdian berhasil ditambahkan.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function update(): void
    {
        ...
        $_SESSION['flash_success'] = 'SK Pengabdian berhasil diperbarui.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function destroy(): void
    {
        ...
        $_SESSION['flash_success'] = 'SK Pengabdian berhasil dihapus.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
}
