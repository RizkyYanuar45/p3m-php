...
require_once __DIR__ . '/../../models/DokumenPenModel.php';
require_once __DIR__ . '/../../middleware/AuthMiddleware.php';

class DokumenPenelitianController
{
    private CatDokumenPenModel $catModel;
    private DokumenPenModel $dokModel;
    private string $baseUrl = '/admin/penelitian/dokumen';

    public function __construct()
    {
        AuthMiddleware::protectAdmin();
        $this->catModel = new CatDokumenPenModel();
        $this->dokModel = new DokumenPenModel();
    }

    /**
     * GET /admin/penelitian/dokumen
    ...
    public function index(): void
    {
        ...
        require_once __DIR__ . "/../../views/admin/CrudDokumenPenelitian.php";
    }

    // ============ CATEGORY CRUD ============

    /**
     * POST /admin/penelitian/dokumen/category/tambah
     */
    ...
    /**
     * POST /admin/penelitian/dokumen/category/edit
     */
    ...
    /**
     * POST /admin/penelitian/dokumen/category/hapus
     */
    ...
    /**
     * POST /admin/penelitian/dokumen/tambah
     */
    public function storeDocument(): void
    {
        $fileName = trim($_POST['file_name'] ?? '');
        $fileUrl  = trim($_POST['file_url'] ?? '');
        $catId    = (int) ($_POST['catdokumenpenId'] ?? 0);
    ...
    /**
     * POST /admin/penelitian/dokumen/edit
     */
    ...
    /**
     * POST /admin/penelitian/dokumen/hapus
     */
