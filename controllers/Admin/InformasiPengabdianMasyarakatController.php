...
class InformasiPengabdianMasyarakatController
{
    private ArticleModel $model;
    private string $category = 'informasi_pengabdian_masyarakat';
    private string $baseUrl = '/admin/pengabdian/informasi';
    ...
    public function index(): void
    {
        ...
        require_once __DIR__ . '/../../views/admin/CrudInformasiPengabdianKepadaMasyarakat.php';
    }
    ...
    public function store(): void
    {
        ...
        $_SESSION['flash_success'] = 'Informasi Pengabdian Masyarakat berhasil ditambahkan.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function update(): void
    {
        ...
        $_SESSION['flash_success'] = 'Informasi Pengabdian Masyarakat berhasil diperbarui.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function destroy(): void
    {
        ...
        $_SESSION['flash_success'] = 'Informasi Pengabdian Masyarakat berhasil dihapus.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
