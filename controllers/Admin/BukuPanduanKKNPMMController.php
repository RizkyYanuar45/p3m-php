...
class BukuPanduanKKNPMMController
{
    private FileModel $model;
    private string $fileType = 'panduan_kkn_pmm';
    private string $baseUrl = '/admin/kkn/panduan-pmm';
    ...
    public function index(): void
    {
        ...
        require_once __DIR__ . "/../../views/admin/CrudBukuPanduanKKNPMM.php";
    }
    ...
    public function store(): void
    {
        ...
        $_SESSION['flash_success'] = 'Buku Panduan PMM berhasil ditambahkan.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function update(): void
    {
        ...
        $_SESSION['flash_success'] = 'Buku Panduan PMM berhasil diperbarui.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
    ...
    public function destroy(): void
    {
        ...
        $_SESSION['flash_success'] = 'Buku Panduan PMM berhasil dihapus.';
        header('Location: ' . $this->baseUrl);
        exit;
    }
}
