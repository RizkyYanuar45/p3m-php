...
<head>
    ...
    <title>Pengabdian Kepada Masyarakat Mandirii - Repositori Publik</title>
    ...
    <div class="relative flex min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <main class="flex-1 max-w-5xl mx-auto w-full px-6 py-8 md:py-12">
            ...
            <div class="mb-10 text-center md:text-left">
                <h1 class="text-[#0d1b16] text-4xl md:text-5xl font-black leading-tight tracking-tight mb-4">Panduan Pengabdian Kepada Masyarakat Mandiri </h1>
            ...
            <div class="space-y-0">
                <?php if (empty($files)): ?>
                    ...
                    <div class="flex flex-col items-center justify-center py-20 text-center">
                        ...
                        <h3 class="text-xl font-bold text-[#0d1b16]">Belum ada dokumen tersedia</h3>
                        <p class="text-[#4c9a79] mt-2">Dokumen pengabdian masyarakat mandiri akan segera diperbarui oleh tim P3M.</p>
                    </div>
                <?php else: ?>
