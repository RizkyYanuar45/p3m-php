...
<head>
    ...
    <title>Informasi Pengabdian Kepada Masyarakat Mandiri | P3M UNIM</title>
        ...
        <section class="mb-12">
            <div class="relative overflow-hidden rounded-2xl bg-slate-900 px-8 py-12 md:py-16 text-white shadow-xl">
                ...
                <div class="relative z-10 max-w-2xl">
                    <h1 class="text-3xl md:text-5xl font-bold leading-tight mb-4">Informasi Pengabdian Kepada Masyarakat Mandiri</h1>
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <?php if (empty($articles)): ?>
                <div class="col-span-full py-20 text-center bg-white dark:bg-slate-900 rounded-2xl border-2 border-dashed border-slate-100 dark:border-slate-800">
                    ...
                    <p class="text-slate-400 mt-2">Informasi pengabdian mandiri akan segera diperbarui oleh tim P3M.</p>
                </div>
            <?php else: ?>
