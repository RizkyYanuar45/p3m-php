...
<head>
    ...
    <title>Dokumen Pengabdian Kepada Masyarakat P3M UNIM</title>
...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen">
    ...
    <div class="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <nav class="flex items-center gap-2 text-sm text-slate-500 dark:text-slate-400 mb-8">
            ...
            <span class="text-slate-900 dark:text-slate-100 font-medium">Dokumen Pengabdian Kepada Masyarakat</span>
        </nav>
        <!-- Hero Section -->
        <div class="mb-10">
            <h2 class="text-4xl font-extrabold tracking-tight mb-2">Dokumen Pengabdian Kepada Masyarakat</h2>
        ...
        <div class="space-y-4">
            <?php if (empty($categories)): ?>
                <div class="bg-white dark:bg-slate-900 border-2 border-dashed border-slate-200 dark:border-slate-800 rounded-xl p-12 text-center">
                    ...
                    <p class="text-slate-400 mt-2">Kategori dan dokumen pengabdian akan segera diperbarui oleh tim P3M.</p>
                </div>
            <?php else: ?>
