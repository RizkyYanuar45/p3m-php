...
<head>
    ...
    <title>Admin - Kelola Informasi Pengabdian Mandiri</title>
</head>
...
<body class="bg-background-light dark:bg-background-dark font-display text-slate-900 dark:text-slate-100 overflow-hidden">
            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-8 custom-scrollbar">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
                    <div class="flex flex-col md:flex-row md:items-center gap-4">
                        <div>
                            <h1 class="text-xl md:text-3xl font-black tracking-tight">Kelola Informasi Pengabdian Mandiri</h1>
                            <p class="text-slate-500 dark:text-slate-400 mt-1">Daftar artikel pengabdian mandiri yang telah diterbitkan.</p>
                        </div>
                        <a href="/informasi-pengabdian-kepada-masyarakat-mandiri" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg font-bold text-sm transition-all border border-slate-200 dark:border-slate-700">
                                ...
                                <?php if (empty($articles)): ?>
                                    <tr>
                                        <td colspan="5" class="px-6 py-12 text-center text-slate-500">
                                            ...
                                            <p>Belum ada artikel informasi pengabdian mandiri yang ditemukan.</p>
                                        </td>
                                    </tr>
                                <?php else: ?>
    ...
    <div id="modal-add" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm p-4">
        <div class="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                <h3 class="text-xl font-bold">Tambah Informasi Mandiri</h3>
            ...
            <form action="/admin/pengabdian/informasi-mandiri/tambah" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
    ...
    <div id="modal-edit" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm p-4">
        <div class="bg-white dark:bg-slate-900 w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-200">
            <div class="p-6 border-b border-slate-100 dark:border-slate-800 flex items-center justify-between">
                <h3 class="text-xl font-bold">Edit Informasi Mandiri</h3>
            ...
            <form action="/admin/pengabdian/informasi-mandiri/edit" method="POST" enctype="multipart/form-data" class="p-6 space-y-4">
    ...
    <div id="modal-delete" class="fixed inset-0 z-50 hidden items-center justify-center bg-black/50 backdrop-blur-sm p-4">
        <div class="bg-white dark:bg-slate-900 w-full max-sm rounded-2xl shadow-2xl overflow-hidden p-8 text-center animate-in fade-in zoom-in duration-200">
            ...
            <form action="/admin/pengabdian/informasi-mandiri/hapus" method="POST" class="flex flex-col gap-3">
