...
<head>
    ...
    <title>Kelola Dokumen Pengabdian Masyarakat</title>
    <style>
        body {
...
<body class="bg-background-light dark:bg-background-dark text-slate-900 dark:text-slate-100 antialiased">
            ...
            <div class="flex-1 overflow-y-auto p-4 md:p-8 bg-background-light dark:bg-background-dark custom-scrollbar">
                <div class="max-w-7xl mx-auto space-y-8">
                    <header class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <h2 class="text-xl md:text-3xl font-black tracking-tight mb-2">Kelola Dokumen Pengabdian Masyarakat</h2>
                            <p class="text-slate-500">Tambah, edit, atau hapus berkas dokumen pengabdian masyarakat dalam sistem.</p>
                        </div>
                        <a href="/dokumen-pengabdian-kepada-masyarakat" target="_blank" class="inline-flex items-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 rounded-lg font-bold text-sm transition-all border border-slate-200 dark:border-slate-700">
                    ...
                    <section class="bg-white dark:bg-background-dark/50 rounded-2xl shadow-sm border border-primary/10 overflow-hidden">
                        <div class="p-6 border-b border-primary/5 flex items-center justify-between">
                            <div class="flex items-center gap-3">
                                ...
                                <h3 class="text-lg font-bold">Kelola Kategori Dokumen Pengabdian</h3>
                            </div>
                        </div>
                        <div class="p-6">
                            <form action="/admin/pengabdian/dokumen/category/tambah" method="POST" class="flex flex-col md:flex-row gap-4 mb-8 bg-primary/5 p-4 rounded-xl border border-primary/10">
                                <div class="flex-1">
                                    <label class="block text-sm font-semibold mb-2 ml-1">Nama Kategori Baru</label>
                                    <input name="name" required class="w-full px-4 py-3 bg-white dark:bg-background-dark border border-primary/20 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl text-sm transition-all" placeholder="Contoh: Dokumen Pengabdian 2026" type="text" />
                                </div>
                                ...
                                <?php foreach ($categories as $cat): ?>
                                    <div class="flex items-center justify-between p-4 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 hover:shadow-md transition-all group">
                                        ...
                                        <div class="flex gap-1 opacity-10 md:opacity-0 group-hover:opacity-100 transition-opacity">
                                            ...
                                            <form id="form-del-cat-<?= $cat['id']; ?>" action="/admin/pengabdian/dokumen/category/hapus" method="POST" class="inline">
                    ...
                    <section class="bg-white dark:bg-background-dark/50 rounded-2xl shadow-sm border border-primary/10 overflow-hidden">
                        <div class="p-6 border-b border-primary/5 flex flex-col md:flex-row md:items-center justify-between gap-4">
                            <div class="flex items-center gap-3">
                                ...
                                <h3 class="text-lg font-bold">Daftar Dokumen Pengabdian Masyarakat</h3>
                            </div>
                                            ...
                                            <tr class="hover:bg-primary/5 transition-colors group">
                                                ...
                                                <td class="px-6 py-4">
                                                    <div class="flex justify-center gap-2">
                                                        ...
                                                        <form id="form-del-dok-<?= $dok['id']; ?>" action="/admin/pengabdian/dokumen/hapus" method="POST" class="inline">
    ...
    <div id="modal-cat" class="modal px-4">
        <div class="bg-white dark:bg-background-dark w-full max-w-md rounded-2xl shadow-2xl overflow-hidden">
            ...
            <form action="/admin/pengabdian/dokumen/category/edit" method="POST" class="p-6 space-y-4">
    ...
    <div id="modal-dokumen" class="modal px-4">
        <div class="bg-white dark:bg-background-dark w-full max-w-lg rounded-2xl shadow-2xl overflow-hidden">
            ...
            <form id="form-dokumen" action="/admin/pengabdian/dokumen/tambah" method="POST" class="p-6 space-y-4">
                ...
                <div>
                    ...
                    <select name="catdokumenpengabId" id="dok-cat" required class="w-full px-4 py-3 bg-slate-50 dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl text-sm focus:ring-primary focus:border-primary">
    ...
    <script>
        ...
        function openEditDok(dok) {
            ...
            document.getElementById('form-dokumen').action = '/admin/pengabdian/dokumen/edit';
            ...
            document.getElementById('dok-cat').value = dok.catdokumenpengabId;
