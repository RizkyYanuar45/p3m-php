...
<head>
    ...
    <title>Panduan Penelitian P3M UNIM - Repositori Publik</title>
    ...
    <div class="relative flex min-h-screen w-full flex-col overflow-x-hidden">
        ...
        <main class="flex-1 max-w-5xl mx-auto w-full px-6 py-8 md:py-12">
            ...
            <div class="mb-10 text-center md:text-left">
                <h1 class="text-[#0d1b16] text-4xl md:text-5xl font-black leading-tight tracking-tight mb-4">Panduan Penelitian P3M</h1>
            ...
            <div class="space-y-0">
                <?php if (empty($files)): ?>
                    <div class="flex flex-col items-center justify-center py-20 text-center bg-white rounded-2xl border-2 border-dashed border-slate-100 dark:border-slate-800">
                        ...
                        <p class="text-[#4c9a79] mt-2">Belum ada panduan penelitian yang diunggah.</p>
                    </div>
                <?php else: ?>
